...
class Joystick:
    ...
    # Left stick X axis value between 2^15 and 2^15 - 1
    def leftX(self):

        raw = int(self.reading[3:9])
        return raw

    # Left stick Y axis value between 2^15 and 2^15 - 1
    def leftY(self):

        raw = int(self.reading[13:19])
        return raw

    # Right stick X axis value between 2^15 and 2^15 - 1
    def rightX(self):

        raw = int(self.reading[24:30])
        return raw

    # Right stick Y axis value between 2^15 and 2^15 - 1
    def rightY(self):
